...
def main():
    sys.argv.append('R:/Academics/Python/Artificial Intelligence/Week 7 Projects/input.csv')
    sys.argv.append('R:/Academics/Python/Artificial Intelligence/Week 7 Projects/Output.csv')
    if len(sys.argv) == 3:
